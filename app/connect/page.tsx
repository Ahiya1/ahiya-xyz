        ...
        <div className="container-content text-center">
          <div className="animate-slideInUp">
            <div className="inline-flex items-center space-x-3 glass-premium px-8 py-4 mb-16">
              <MessageCircle className="w-6 h-6 text-consciousness-400" />
                  ...
                  <div className="text-center py-20">
                    ...
                    <p className="body-lg text-gray-300 mb-12 leading-relaxed">
                      ...
                      <a
                        ...
                        className="text-consciousness-400 hover:text-consciousness-300 underline"
                      >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                          ...
                          <input
                            ...
                            required
                            className="w-full px-6 py-4 bg-white/5 border border-gray-600/30 rounded-2xl 
                              text-white placeholder-gray-400 focus:outline-none focus:border-consciousness-400/50 
