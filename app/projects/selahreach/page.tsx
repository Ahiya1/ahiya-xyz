...
import { ChevronDown, Lock, ArrowRight, Mail, Terminal, Play, Check } from "lucide-react";
...
const PIPELINE_STAGES = [
  ...
  { id: 'call_scheduled', label: 'Call Scheduled', color: 'bg-amber-500' },
...
const SAMPLE_CONTACTS: Contact[] = [
  { id: '1', name: 'Lior Katz', company: '500Tech', stage: 'lead', email: 'lior@500tech.io' },
  { id: '2', name: 'Yael Chen', company: 'Wix', stage: 'contacted', email: 'yael@wix.com' },
  { id: '3', name: 'David Mor', company: 'Monday.com', stage: 'replied', email: 'david@monday.com' },
  { id: '4', name: 'Sarah Levi', company: 'Fiverr', stage: 'call_scheduled', email: 'sarah@fiverr.com' },
  { id: '5', name: 'Ron Bar', company: 'JFrog', stage: 'proposal', email: 'ron@jfrog.com' },
];
              ...
              <div className="space-y-2 min-h-[120px]">
                {contacts
                  ...
                  .map((contact) => (
                    <div
                      key={contact.id}
                      className={`p-3 rounded-lg bg-slate-800/80 border transition-all duration-300 ${
...
function ClaudeCodeWorkflowDemo() {
  ...
  const workflowSteps = [
    ...
    {
      type: 'email',
      text: `Subject: AI-Powered Development for 500Tech
...
happy to show you how it works if you're curious.`,
  ...
  const getStepStyles = (type: string) => {
    switch (type) {
      ...
      case 'email':
        return 'text-slate-300 bg-slate-800/50 p-3 rounded-lg whitespace-pre-wrap text-xs';
      case 'success':
    ...
    <div className="min-h-screen bg-[#0a0f1a] text-white relative overflow-hidden">
      ...
      <section className="py-24 section-reveal section-reveal-2">
        <div className="container-content">
          ...
          {/* The P.S. Line Highlight */}
          <div className="mt-8 max-w-xl mx-auto">
            <div className="contemplative-card p-6 text-center border-purple-400/20">
              <p className="text-sm text-slate-400 mb-2">Every email includes:</p>
