...
import { TiltCard, AnimatedIcon, type IconType } from "@/app/components/reactive";
...
export function PortfolioCard({ project, index = 0 }: PortfolioCardProps) {
  ...
  return (
    <Link
      ...
      data-track-click={`portfolio:${project.id || project.title.toLowerCase().replace(/\s+/g, '_')}`}
    >
      <TiltCard maxTilt={6} enableShine={true}>
        <div
          ref={ref}
        ...
        >
          ...
          <div className="relative h-full bg-[#0d1220] border border-white/[0.08] rounded-3xl overflow-hidden group-hover:border-white/[0.15] transition-all duration-500">
            ...
            <div className="relative h-44 overflow-hidden">
              ...
              {/* Icon container with AnimatedIcon */}
